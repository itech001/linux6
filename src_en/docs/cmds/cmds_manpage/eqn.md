...
```
       ...
       eqn searches for the file eqnrc in the directories given with the -M option first, then in /usr/lib/groff/site-tmac, /usr/share/groff/site-tmac, and finally in the standard macro directory /usr/share/groff/1.22.2/tmac.  If it exists, eqn processes it before the other input files.  The -R option prevents this.
