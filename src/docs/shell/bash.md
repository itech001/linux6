...
#bash  
[bash manpage](bash_man.md)  
more examples: [100 shell script examples](https://github.com/itech001/100-shell-script-examples) /  [bash example](https://github.com/itech001/bash-example)
```
